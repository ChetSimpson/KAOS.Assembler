...
Version 0.0 is an update to the current release of KASM. It includes several
...
Three new output file formats have been included with this release. KASM
...
precedence as with languages such as C. This version of KASM does however
...
The final version of KASM 0.0 will clearly define these conditions and
...
In order to maintain compatibility with other assemblers KASM accepts a
...
---------------------------------------------
	...
	KASM has an internal Direct Page stack limit of 255.
